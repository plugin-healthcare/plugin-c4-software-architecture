...
// Apply Figtree to outline (TOC) and cover page BEFORE book.with() so
// the rules are in the outer scope and apply to content rendered inside
// book() before body (cover page, TOC).
...
// Apply Figtree font inside the orange-book scope for headings and body text.
