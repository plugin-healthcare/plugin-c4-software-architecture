...
De architectuur van PLUGIN neemt onverkort de uitgangspunten voor landelijk dekkend netwerk voor databeschikbaarheid over, te weten[^01-inleiding-doelen-1]:

[^01-inleiding-doelen-1]: Zie <https://www.datavoorgezondheid.nl/onderwerpen/l/landelijk-dekkend-netwerk>
...
| Functionele componenten | Omschrijving |
|-------------------------|--------------|
...
| Generieke componenten | Omschrijving |
|-------------------------|--------------|
| PLUGIN-Rosetta | Component waarmee transformaties  |
| PLUGIN-NUTS | Component voor decentrale identificatie en ... |
| PLUGIN-... | Component waarmee gegevensaanleveringen kunnen worden uitgevoerd |


## Kwaliteitseisen

PLUGIN streeft ernaar om de kwaliteitseisen zoals in TEHDAS2 zijn geformuleerd te realiseren. De eisen zijn in onderstaande tabellen weergegeven. **TO DO:** prioritering toevoegen aan tabellen(laag-middel-hoog).
